    ...
    chrome.identity.launchWebAuthFlow(
      ...
      (redirectUrl) => {
        if (chrome.runtime.lastError) {
          ...
          if (!tokenMatch) return reject("Token not found");
    ...
    (function () {
      ...
      function createPWDBtn() {
        ...
        function fillAllFieldsPWD() {
          ...
          document.querySelectorAll("select").forEach(sel => {
            if (sel.value.trim() === "") {
              let opt = [...sel.options].find(o => o.text.toLowerCase() === FILL_TEXT.toLowerCase());
      ...
      function createNAButton() {
        ...
        function fillAllFields() {
          ...
          document.querySelectorAll("select").forEach(sel => {
            if (sel.value.trim() === "") {
              let opt = [...sel.options].find(o =>
                o.text.toLowerCase() === FILL_TEXT.toLowerCase()
              );
